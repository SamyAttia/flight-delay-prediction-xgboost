...
* [`airport_codes.csv`](https://www.kaggle.com/datasets/hetsuhagiya/flight-delays-cleanded?select=new.csv) – Basic airport metadata (IATA, name, location)  
* [`airports.csv`](https://www.kaggle.com/datasets/hetsuhagiya/flight-delays-cleanded?select=new.csv) – Detailed global airport data (latitude/longitude, region, etc.)
